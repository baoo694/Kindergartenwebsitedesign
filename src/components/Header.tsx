import { Sparkles, BookOpen, Video, GamepadIcon, LogIn, Menu, X } from 'lucide-react';
...
type HeaderProps = {
  ...
  backButtonPage?: string; // Trang để quay lại khi bấm nút back
  navigateTo: (page: string) => void;
};

export default function Header({ title = 'Thế Giới Mầm Non', showNav = true, showBackButton = false, backButtonPage = 'home', navigateTo }: HeaderProps) {
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <h1 className="text-white text-lg md:text-2xl lg:text-3xl">{title}</h1>
          </div>
